...
const CONTROL =
  'w-full rounded-lg border border-input bg-card px-3 py-2 text-sm text-ink placeholder:text-faint focus:border-pine focus:ring-2 focus:ring-pine/20 disabled:opacity-60'
