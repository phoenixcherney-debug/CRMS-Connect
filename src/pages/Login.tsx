          ...
          {forgotMode ? (
              ...
              {resetSent ? (
                ...
                <>
                  ...
                  <form onSubmit={handleForgotSubmit} className="space-y-4" noValidate>
                    <div>
                      <label htmlFor="reset-email" className="block text-sm font-700 text-ink mb-1.5" style={{ fontWeight: 700 }}>
                        Email address
                      </label>
                      <input
                        id="reset-email"
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <label htmlFor="password" className="block text-sm text-ink" style={{ fontWeight: 700 }}>
                      Password
                    </label>
                    <button
                      type="button"
                      onClick={enterForgotMode}
                      className="text-xs font-700 hover:underline"
              ...
              <p className="mt-6 text-center text-sm text-ink-muted">
                ...
                <Link to="/signup" className="font-800 hover:underline" style={{ color: 'var(--color-primary)', fontWeight: 800 }}>
                  Create one
                </Link>
              </p>
            </>
